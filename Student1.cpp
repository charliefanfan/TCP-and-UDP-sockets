...
cout<<"<Student 1> has TCP port "<<ntohs(serv.sin_port)<<" and IP address "<<ip<<endl;
char line[50],line1[50],line2[50],line3[50];  
ifstream file("student1.txt");   //read the text
...
cout<<"<Student1> has UDP port " <<DPORT<<" and IP address "<< ip<<" for Phase 2"<<endl;
cout<<"<Student1> has received the application result, the result is: "<<endl;
cout<<rec<<endl;
return 0;
}
