...
cout<<"<Student 5> has TCP port "<<ntohs(serv.sin_port)<<" and IP address "<<ip<<endl;
char line[50],line1[50],line2[50],line3[50];  
ifstream file("student5.txt");   //read the text
...
clientudp.sin_port = htons(22134);
...
cout<<"<Student5> has UDP port " <<DPORT<<" and IP address "<< ip<<" for Phase 2"<<endl;
cout<<"<Student5> has received the application result, the result is: "<<endl;
cout<<rec<<endl;
return 0;
}
